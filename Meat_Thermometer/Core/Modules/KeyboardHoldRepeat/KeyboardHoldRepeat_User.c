...
uint8_t ScanKeyboard(void)
{
  ...
  keyCode = (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_10) << 3) | (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_5) << 2) | (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_8) << 1) | (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_0) << 0);
